...
% Responsáveis: Juliana Ballin Lima, Allef Oliveira Ramos e Thailsson Clementino de Andrade
% ==============================================================================
...
\hypersetup{
  ...
  citecolor   = apidark,
  pdftitle    = {Relatório Técnico - Academic Events API},
  pdfauthor   = {Juliana Ballin Lima, Allef Oliveira Ramos e Thailsson Clementino de Andrade},
...
\textbf{Integrantes:} & Juliana Ballin Lima, Allef Oliveira Ramos e Thailsson Clementino de Andrade \\[2mm]
\textbf{Data:}       & Junho de 2026 \\[2mm]
\end{tabular}

\vspace{10mm}

\begin{tcolorbox}[requisito, title={Autoria do Relatório}, width=0.85\linewidth]
\begin{tabular}{ll}
1. & Juliana Ballin Lima - \url{https://github.com/JulianaBallin} \\
2. & Allef Oliveira Ramos - \url{https://github.com/allef-oliveira} \\
3. & Thailsson Clementino de Andrade - \url{https://github.com/clementino1971} \\
\end{tabular}
\end{tcolorbox}
...
\rowcolor{tablealt}
Activity & Id, Titulo, Descricao, Tipo, EventoId & Atividades que fazem parte da programação de um evento. \\
\bottomrule
\end{longtable}
...
\rowcolor{tablealt}
TipoAtividade &     Abertura, Palestra, Workshop, MesaRedonda, CoffeBreak, Encerramento, SessaoTecnica, Outro\\
\bottomrule
\end{longtable}
...
\begin{longtable}{L{1.5cm} L{6cm} L{1.5cm} L{5.5cm}}
\toprule
\rowcolor{tablehead}
...
\midrule
\endhead
GET & /api/activity/{id} & Não & Retorna uma atividade pelo id \\
\rowcolor{tablealt}
GET & /api/activity/event/{eventId} & Não & Retorna todas as atividades de um evento pelo EventId \\
POST & /api/activity & Sim & Cria uma nova atividade. Só o organizador do evento pode criar as atividades associadas. \\
\rowcolor{tablealt}
PUT & //api/activity/{id} & Sim & Edita uma atividade. Só o organizador do evento pode editar atividades associadas. \\
DELETE & /api/activity/{id} & Sim & Remove uma atividade. Só o organizador do evento pode excluir atividades associadas. \\
\end{longtable}
...
\subsection{Formato dos Enums nos Contratos}

O projeto configura o \texttt{JsonStringEnumConverter} no \texttt{Program.cs}. Com isso, os campos de enum podem ser enviados como texto no corpo das requisições, mantendo os exemplos do Swagger e do arquivo \texttt{endpoints.http} mais legíveis. Exemplos: \texttt{"Publicado"} para \texttt{StatusEvento} e \texttt{"VouParticipar"} para \texttt{TipoReacao}.
...
Após iniciar, acesse a documentação interativa no Swagger em: \url{http://localhost:5136/swagger}
...
Além dos requisitos mínimos, o projeto implementou:
